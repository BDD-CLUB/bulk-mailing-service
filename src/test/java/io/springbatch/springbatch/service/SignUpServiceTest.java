...
class SignUpServiceTest extends IntegrationTest {
    ...
    void 성공적으로_멤버가_저장되어야_한다() {
        memberService.signUp("02ggang9", "ggang9", "qwer1234", "testggang9@gmail.com");

        em.flush();
        em.clear();

        Member findMember = memberRepository.findByName("02ggang9")
                .orElseThrow();

        Assertions.assertThat(findMember.getName()).isEqualTo("02ggang9");
    }
